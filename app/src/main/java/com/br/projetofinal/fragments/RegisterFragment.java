...
public class RegisterFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TabLayout tabLayout = view.findViewById(R.id.register_select_type_user);
        ...
        tabLayout.addOnTabSelectedListener(new OnTabSelectedListener(){
            @Override public void onTabSelected(TabLayout.Tab tab) {
                isCommon = Objects.requireNonNull(tab.getText()).toString().equals(Common.TAG);
            }
        ...
        registerButton.setOnClickListener(viewClick -> {
            ...
            MySystem.registerUser(isCommon ? new Common(name, email) :new Teacher(name, email), password,getActivity());
        });
        return view;
    }
